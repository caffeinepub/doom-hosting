...
import type { MinecraftServer as _MinecraftServer, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPlan(arg0: HostingPlan): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addPlugin(arg0: Plugin): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPlugin(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createServer(arg0: string): Promise<MinecraftServer> {
        if (this.processError) {
            try {
    ...
    async getAllServers(): Promise<Array<MinecraftServer>> {
        if (this.processError) {
            try {
    ...
    async getMyServers(): Promise<Array<MinecraftServer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyServers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlans(): Promise<Array<HostingPlan>> {
        if (this.processError) {
            try {
    ...
    async getPlugins(): Promise<Array<Plugin>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlugins();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServer(arg0: string): Promise<MinecraftServer | null> {
        if (this.processError) {
            try {
    ...
    async getServerPermissions(arg0: string): Promise<Array<ServerPermission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getServerPermissions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async grantServerPermission(arg0: string, arg1: Principal, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.grantServerPermission(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async installPluginToServer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.installPluginToServer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async processStripePayment(arg0: Array<ShoppingItem>, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.processStripePayment(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordPayment(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async removePluginFromServer(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removePluginFromServer(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async revokeServerPermission(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.revokeServerPermission(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateServerStatus(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateServerStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MinecraftServer]): MinecraftServer | null {
    return value.length === 0 ? null : value[0];
}
